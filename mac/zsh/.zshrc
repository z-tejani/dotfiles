...
# ------------------------------------------------------------------------------
# Previous prompt setup: Powerlevel10k
# Kept here commented out in case you want to switch back later.
# ------------------------------------------------------------------------------
...
# Aliases
alias bu="brew update; brew upgrade --greedy; brew autoremove; mas update"
alias z="zoxide"
alias cat="bat"
alias find="fd"
alias ls="ls --color"
